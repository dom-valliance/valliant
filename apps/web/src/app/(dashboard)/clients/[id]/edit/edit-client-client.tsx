...
export function EditClientClient({ clientId }: { clientId: string }) {
      ...
      {clientLoading ? (
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex gap-4">
            <Button type="submit" disabled={updateClient.isPending || clientLoading}>
            ...
            <Link href={`/clients/${clientId}`}>
              <Button type="button" variant="outline" disabled={updateClient.isPending}>
                Cancel
              </Button>
            </Link>
          </div>
