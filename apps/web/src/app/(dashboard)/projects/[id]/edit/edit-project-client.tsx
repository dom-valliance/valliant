...
export function EditProjectClient({ projectId }: { projectId: string }) {
  ...
  useEffect(() => {
    if (project) {
      setFormData({
        ...
        primaryPracticeId: project.primaryPracticeId,
        valuePartnerId: project.valuePartnerId,
        status: project.status as ProjectStatus,
        startDate: project.startDate.split('T')[0],
        endDate: project.endDate ? project.endDate.split('T')[0] : '',
        projectType: project.projectType as ProjectType,
        teamModel: project.teamModel as TeamModel,
        commercialModel: project.commercialModel as CommercialModel,
        estimatedValueCents: project.estimatedValueCents?.toString() || '',
        valueSharePct: project.valueSharePct?.toString() || '',
        agreedFeeCents: project.agreedFeeCents?.toString() || '',
        contingencyPct: project.contingencyPct?.toString() || '0.2',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload: Parameters<typeof updateProject.mutateAsync>[0]['data'] = {
        name: formData.name,
        code: formData.code,
  ...
  const isLoading = projectLoading || clientsLoading || practicesLoading || peopleLoading;
  ...
  return (
    <div className="container mx-auto py-8 max-w-3xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Update project details and commercial model</p>
      </div>
      ...
      {isLoading ? (
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex gap-4">
            <Button type="submit" disabled={updateProject.isPending || isLoading}>
