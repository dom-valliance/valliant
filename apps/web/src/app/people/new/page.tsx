...
export default function NewPersonPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    roleId: '',
    seniority: 'MID' as 'JUNIOR' | 'MID' | 'SENIOR' | 'PRINCIPAL' | 'PARTNER',
    costRateCents: 70000,
  ...
  const isLoading = rolesLoading || practicesLoading;
  ...
  return (
    <div className="container mx-auto py-8 max-w-2xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Create a new employee or contractor profile</p>
      </div>
        ...
        <form onSubmit={handleSubmit}>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Enter the person's core details</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(
                    value: 'JUNIOR' | 'MID' | 'SENIOR' | 'PRINCIPAL' | 'PARTNER'
          ...
          <div className="mt-6 flex gap-4">
            <Button type="submit" disabled={createPerson.isPending || isLoading}>
            ...
            <Link href="/people">
              <Button type="button" variant="outline" disabled={createPerson.isPending}>
                Cancel
              </Button>
            </Link>
          </div>
